...
r = requests.post('http://localhost/api/v0/users/', data=json.dumps({'name':'test_user_6','profilePictureUrl': 'http://www.usip.org/sites/default/files/Andrew-Wilder_1.jpg'}), headers = {'content-type': 'application/json'})
